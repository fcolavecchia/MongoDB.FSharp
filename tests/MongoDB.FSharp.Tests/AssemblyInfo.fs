...
[<assembly: AssemblyTitleAttribute("MongoDB.FSharp.Tests")>]
[<assembly: AssemblyProductAttribute("MongoDB.FSharp")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "MongoDB.FSharp.Tests"
    let [<Literal>] AssemblyProduct = "MongoDB.FSharp"
